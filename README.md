...
Using Turn Off the Lights it dims the web page and reduces the eye strain caused by a bright screen. And it will highlight the video player on that web page.
