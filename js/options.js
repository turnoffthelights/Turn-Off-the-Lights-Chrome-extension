...
function save_options(){
	...
	// videotool Excluded domains
	var videovolumeDomainsBox = $("videovolumeDomainsBox");
	var videovolumeDomains = {};
	var videovolumei;
	var videovolumel = videovolumeDomainsBox.length;
	for(videovolumei = 0; videovolumei < videovolumel; videovolumei++){ videovolumeDomains[videovolumeDomainsBox.options[videovolumei].value] = true; }
...
function test(){
	...
	if($("customqualityyoutube").checked == true){ $("youtubequality").disabled = false; $("block60fps").disabled = false; }else{ $("youtubequality").disabled = true; $("block60fps").disabled = true; }
